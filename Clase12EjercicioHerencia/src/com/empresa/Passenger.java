...
//correctamente 
public class Passenger extends Persona {
	...
	public Passenger(String nombre, String apellido, int edad, long numeroDocumento) {
		// invocamos al constructor de la clase padre persona
		super(nombre, apellido, edad, numeroDocumento);
	}
	...
	// constructor 3 con dos parametro , estye llama al constructor 2 que a su vez
	// invoca al constructor 4 private
	...
	// lo hacemos private para darle seguridad al sistema y que no se pueda
	// modificar el valor de la tarifa por bolse
	...
	public String toString() {
		return "Passenger [bolsos=" + bolsos + ", bolsosPagos=" + bolsosPagos + ", tarifaXbolso=" + tarifaXbolso
				+ ", totalaPagar=" + totalaPagar + ", totalEquipaje=" + totalEquipaje + ", nombre=" + nombre
				+ ", apellido=" + apellido + ", edad=" + edad + ", numeroDocumento=" + numeroDocumento + "]";
	}
}
